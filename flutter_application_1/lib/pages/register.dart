                    ...
                    onPressed: () {
                      setState(() {
                        if (Username.text.isEmpty ||
                          ...
                          for (var i = 0;
                              i < Account.ambildatalist.length;
                              i++) {
                            if (Username.text ==
                                    Account.ambildatalist[i]['Username'] &&
                                Password.text ==
                                    Account.ambildatalist[i]['Password'] &&
                                Email.text ==
                                    Account.ambildatalist[i]['Email'] &&
                                Mobile.text ==
                                    Account.ambildatalist[i]['NoTelp']) {
                              setState(() {
                                dapat = i;
                              });
                            }
                          ...
                          if (dapat != -1) {
                            ...
                            Account.tambahaccount(Username.text, Password.text,
